        ...
        <div class="col-12 my-5">
            <div class="card">
                <div class="card-header  d-flex justify-content-between align-items-center">
                    <h1 class="float-start">{{ __('Permision List') }}</h1>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group">
                                            ...
                                            <a href="{{ route('permission.edit', $permission->id) }}" class="btn btn-info btn-sm">{{ __('Edit') }}</a>
                                            @endif
                                            @if (auth()->user()->can('permission-delete'))
                                            <a href="{{ route('permission.delete', $permission->id) }}" class="btn btn-danger btn-sm">{{ __('Delete') }}</a>
                                            @endif
                                        </div>
                                    </td>
                                </tr>
