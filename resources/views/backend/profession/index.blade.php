        ...
        <div class="col-12 my-5">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h1 class="float-start">Profession List</h1>
                    <a href="{{ route('profession.create') }}" class="btn btn-info btn-sm float-end align-items-center px-2 py-2">Add Profession</a>
                </div>
                <div class="card-body">
