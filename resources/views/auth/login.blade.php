...
@section('content')
<div class="login bg-gradient-primary">
    <div class="container">
                                ...
                                <div class="p-5">
                                    ...
                                    <form class="user" method="POST" action="{{ route('login') }}" >
                                        ...
                                        <div class="form-group">
                                                    ...
                                                    <input type="email" class="form-control form-control-user @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required  placeholder="Enter Email Address..." autocomplete="email" autofocus>
